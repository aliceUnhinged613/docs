...
The best way to do this is using [{{ $names.cli.lower }}][cli]. Install the CLI, plug your SD Card into your computer and run the following command, passing the correct device type associated with your image.
